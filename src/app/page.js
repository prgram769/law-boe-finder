...
export default function Home() {
  ...
  return (
    <main className="min-h-screen  bg-[#222] font-sans">
      ...
      <section>
        <h2 className="font-bold text-center bg-blue-800 px-1 py-1 ml-6 mr-6 sm:w-1/4 sm:m-auto text-black rounded">
        ...
        <div className="flex sm:flex-row sm:justify-center flex-col items-center m-3">
          <Button
            text={"Summary"}
            className={"hover:animate-bounce bg-[#0C4678] rounded-2xl sm:w-auto w-1/2 text px-2 py-2 m-2"}
            onClick={() => handleClick("sumary")}
          />
          <Button
            text={"Consolidated legislation"}
            className={"transition duration-1000 ease-in-out hover:bg-indigo-300 bg-[#0C4678] rounded-2xl px-2 py-2 m-2"}
